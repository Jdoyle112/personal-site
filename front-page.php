...
<?php $uploads = wp_upload_dir(); ?>
	<div class="section main" style="background: url(<?php echo $uploads['url']; ?>/sky.jpg)">
		<div class="container">
			<div class="content">
				<h1>Jack Doyle</h1>
				<div class="underline"></div>
				<p>I <strong>love</strong> <span class="typing"></span></p>				
			</div>
		</div>
	</div>
			...
			<div class="content">
				<div class="row">
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
					    <div class="item">
					    	<a href="http://www.educationsuperhighway.org/">
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">       
					    <div class="item">
					    	<a href="http://b17entertainment.com/">
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">       
					    <div class="item">
					    	<a href="https://github.com/Jdoyle112/NFL_simApp/tree/master/NFL_simApp">
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
					    <div class="item">
					    	<a href="https://wordpress.org/plugins/wp-compare/">
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-4"> 
					    <div class="item">
					    	<a href="https://github.com/Jdoyle112/Fun_Ninja_Games">
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">       
					    <div class="item">
					    	<a href="https://github.com/Jdoyle112/stock_scrape">
